...
def build_metric_rows(rr, pf, reference_baseline, compare_baseline):
    metrics = [
        ...
        {
            "name": "traffic.packet_effective_delivered_pkt_count",
            "unit": None,
            "direction": "higher_better",
            "rr": safe_get(rr, "traffic", "packet_effective_delivered_pkt_count"),
            "pf": safe_get(pf, "traffic", "packet_effective_delivered_pkt_count"),
        },
        {
            "name": "traffic.packet_effective_total_delivered_bits",
            "unit": None,
            "direction": "higher_better",
            "rr": safe_get(rr, "traffic", "packet_effective_total_delivered_bits"),
            "pf": safe_get(pf, "traffic", "packet_effective_total_delivered_bits"),
        },
        {
            "name": "traffic.packet_effective_total_system_time_ms",
            "unit": "ms",
            "direction": "lower_better",
            "rr": safe_get(rr, "traffic", "packet_effective_total_system_time_ms"),
            "pf": safe_get(pf, "traffic", "packet_effective_total_system_time_ms"),
        },
        {
            "name": "traffic.packet_effective_service_rate_mbps",
            "unit": "Mbps",
            "direction": "higher_better",
            "rr": safe_get(rr, "traffic", "packet_effective_service_rate_mbps"),
            "pf": safe_get(pf, "traffic", "packet_effective_service_rate_mbps"),
        },
        {
            "name": "traffic.packet_effective_service_rate_per_packet_mean_mbps",
            "unit": "Mbps",
            "direction": "higher_better",
            "rr": safe_get(rr, "traffic", "packet_effective_service_rate_per_packet_mean_mbps"),
