...
public:
     ...
     * @param _pdh       - Cuphydriver handle
     * @param _gDev      - GPU device struct handle
     * @param _resources - Device resources, currently SM-type, this green context will be provisioned with.
     */
    MpsCtx(phydriver_handle _pdh, GpuDevice* _gDev, CUdevResource* _resources);
#endif
