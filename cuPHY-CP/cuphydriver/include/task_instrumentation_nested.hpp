...
struct ti_subtask_info {
    char tname[MAX_NUM_SUBTASKS][MAX_SUBTASK_CHARS]{}; ///< Array of subtask names
    int count{};                                         ///< Current number of recorded subtasks
    t_ns time[MAX_NUM_SUBTASKS]{};                      ///< Array of subtask timestamps
}; 
...
if ((task_info.count < MAX_NUM_SUBTASKS) && (ENABLE_SUBTASK_INSTRUMENTATION == true))  { \
