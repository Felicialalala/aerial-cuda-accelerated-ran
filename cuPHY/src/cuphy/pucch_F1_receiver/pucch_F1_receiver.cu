...
static __device__ __constant__ __half d_Wf[12][12];
static __half Wf[12][12] = {{0.052185, 0.053162, 0.053436, 0.053040, 0.051971, 0.050262, 0.034332, 0.029938, 0.025330, 0.020645, 0.015945, 0.011337},
                            {0.050598, 0.052185, 0.053162, 0.053436, 0.053040, 0.051971, 0.038483, 0.034332, 0.029938, 0.025330, 0.020645, 0.015945},
                            {0.048370, 0.050598, 0.052185, 0.053162, 0.053436, 0.053040, 0.042236, 0.038483, 0.034332, 0.029938, 0.025330, 0.020645},
                            {0.045563, 0.048370, 0.050598, 0.052185, 0.053162, 0.053436, 0.045563, 0.042236, 0.038483, 0.034332, 0.029938, 0.025330},
                            {0.042236, 0.045563, 0.048370, 0.050598, 0.052185, 0.053162, 0.048370, 0.045563, 0.042236, 0.038483, 0.034332, 0.029938},
                            {0.038483, 0.042236, 0.045563, 0.048370, 0.050598, 0.052185, 0.050598, 0.048370, 0.045563, 0.042236, 0.038483, 0.034332},
                            {0.034332, 0.038483, 0.042236, 0.045563, 0.048370, 0.050598, 0.052185, 0.050598, 0.048370, 0.045563, 0.042236, 0.038483},
                            {0.029938, 0.034332, 0.038483, 0.042236, 0.045563, 0.048370, 0.053162, 0.052185, 0.050598, 0.048370, 0.045563, 0.042236},
                            {0.025330, 0.029938, 0.034332, 0.038483, 0.042236, 0.045563, 0.053436, 0.053162, 0.052185, 0.050598, 0.048370, 0.045563},
                            {0.020645, 0.025330, 0.029938, 0.034332, 0.038483, 0.042236, 0.053040, 0.053436, 0.053162, 0.052185, 0.050598, 0.048370},
                            {0.015945, 0.020645, 0.025330, 0.029938, 0.034332, 0.038483, 0.051971, 0.053040, 0.053436, 0.053162, 0.052185, 0.050598},
                            {0.011337, 0.015945, 0.020645, 0.025330, 0.029938, 0.034332, 0.050262, 0.051971, 0.053040, 0.053436, 0.053162, 0.052185}};
...
static __device__ __constant__ __half d_Wt_1_1[1][1];
static __half Wt_1_1[1][1] = {{1.00000}};

static __device__ __constant__ __half d_Wt_1_2[1][2];
static __half Wt_1_2[1][2] = {{1.00000,1.00000}};

static __device__ __constant__ __half d_Wt_2_1[2][1];
static __half Wt_2_1[2][1] = {{0.500000},
                              {0.500000}};
...
static __device__ __constant__ __half d_Wt1_2_2[2][2];
static __half Wt1_2_2[2][2] = {{0.500000, 0.500000},
                                {0.500000, 0.500000}};

static __device__ __constant__ __half d_Wt2_2_2[2][2];
static __half Wt2_2_2[2][2] = {{0.500000,0.500000},
                               {0.500000,0.500000}};


static __device__ __constant__ __half d_Wt_2_3[2][3];
static __half Wt_2_3[2][3] = {{0.500000,0.500000,0.500000},
                              {0.500000,0.500000,0.500000}};

static __device__ __constant__ __half d_Wt_3_2[3][2];
static __half Wt_3_2[3][2] = {{0.333252,0.333252},
                              {0.333252,0.333252},
                              {0.333252,0.333252}};
...
static __device__ __constant__ __half d_Wt1_3_3[3][3];
static __half Wt1_3_3[3][3] = {{0.333252,0.333252,0.333252},
                               {0.333252,0.333252,0.333252},
                               {0.333252,0.333252,0.333252}};

static __device__ __constant__ __half d_Wt2_3_3[3][3];
static __half Wt2_3_3[3][3] = {{0.333252,0.333252,0.333252},
                               {0.333252,0.333252,0.333252},
                               {0.333252,0.333252,0.333252}};

static __device__ __constant__ __half d_Wt_3_4[3][4];
static __half Wt_3_4[3][4] = {{0.333252,0.333252,0.333252,0.333252},
                              {0.333252,0.333252,0.333252,0.333252},
                              {0.333252,0.333252,0.333252,0.333252}};
                              
static __device__ __constant__ __half d_Wt_4_3[4][3];
static __half Wt_4_3[4][3] = {{0.250000,0.250000,0.250000},
                              {0.250000,0.250000,0.250000},
                              {0.250000,0.250000,0.250000},
                              {0.250000,0.250000,0.250000}};

static __device__ __constant__ __half d_Wt_4_4[4][4];       
static __half Wt_4_4[4][4] = {{0.250000,0.250000,0.250000,0.250000},
                              {0.250000,0.250000,0.250000,0.250000},
                              {0.250000,0.250000,0.250000,0.250000},
                              {0.250000,0.250000,0.250000,0.250000}}; 
                              
static __device__ __constant__ __half d_Wt_5_4[5][4];      
static __half Wt_5_4[5][4] = {{0.199951,0.199951,0.199951,0.199951},
                              {0.199951,0.199951,0.199951,0.199951},
                              {0.199951,0.199951,0.199951,0.199951},
                              {0.199951,0.199951,0.199951,0.199951},
                              {0.199951,0.199951,0.199951,0.199951}};     
                              
static __device__ __constant__ __half d_Wt_5_5[5][5];                              
static __half Wt_5_5[5][5] = {{0.199951,0.199951,0.199951,0.199951,0.199951},
                              {0.199951,0.199951,0.199951,0.199951,0.199951},
                              {0.199951,0.199951,0.199951,0.199951,0.199951},
                              {0.199951,0.199951,0.199951,0.199951,0.199951},
                              {0.199951,0.199951,0.199951,0.199951,0.199951}};

static __device__ __constant__ __half d_Wt_6_5[6][5];
static __half Wt_6_5[6][5] = {{0.166626,0.166626,0.166626,0.166626,0.166626},
                              {0.166626,0.166626,0.166626,0.166626,0.166626},
                              {0.166626,0.166626,0.166626,0.166626,0.166626},
                              {0.166626,0.166626,0.166626,0.166626,0.166626},
                              {0.166626,0.166626,0.166626,0.166626,0.166626},
                              {0.166626,0.166626,0.166626,0.166626,0.166626}};

static __device__ __constant__ __half d_Wt_6_6[6][6];
static __half Wt_6_6[6][6] = {{0.166626,0.166626,0.166626,0.166626,0.166626,0.166626},
                              {0.166626,0.166626,0.166626,0.166626,0.166626,0.166626},
                              {0.166626,0.166626,0.166626,0.166626,0.166626,0.166626},
                              {0.166626,0.166626,0.166626,0.166626,0.166626,0.166626},
                              {0.166626,0.166626,0.166626,0.166626,0.166626,0.166626},
                              {0.166626,0.166626,0.166626,0.166626,0.166626,0.166626}};

static __device__ __constant__ __half d_Wt_7_6[7][6]; 
static __half Wt_7_6[7][6] = {{0.142822,0.142822,0.142822,0.142822,0.142822,0.142822},
                              {0.142822,0.142822,0.142822,0.142822,0.142822,0.142822},
                              {0.142822,0.142822,0.142822,0.142822,0.142822,0.142822},
                              {0.142822,0.142822,0.142822,0.142822,0.142822,0.142822},
                              {0.142822,0.142822,0.142822,0.142822,0.142822,0.142822},
                              {0.142822,0.142822,0.142822,0.142822,0.142822,0.142822},
...
static __device__ __constant__ __half d_Wt_7_7[7][7];
static __half Wt_7_7[7][7] = {{0.142822,0.142822,0.142822,0.142822,0.142822,0.142822,0.142822},
                              {0.142822,0.142822,0.142822,0.142822,0.142822,0.142822,0.142822},
                              {0.142822,0.142822,0.142822,0.142822,0.142822,0.142822,0.142822},
                              {0.142822,0.142822,0.142822,0.142822,0.142822,0.142822,0.142822},
                              {0.142822,0.142822,0.142822,0.142822,0.142822,0.142822,0.142822},
                              {0.142822,0.142822,0.142822,0.142822,0.142822,0.142822,0.142822},
...
static constexpr float    RAD_TO_USEC = 1000000.0f/(2.0f*M_PI);

// Values copied from MATLAB for different numbers of Rx antennas
static constexpr float ALPHA_DEFAULT = 92.5f;
static constexpr float ALPHA_R1R2    = 31.0f/3;
static constexpr float ALPHA_R3R4R5  = 23.5f;
...
static constexpr uint32_t PUCCH_F1_MIN_BLKS_PER_SM = 11; // this may change based on changes in register usage in pucchF1RxKernel
...
void pucchF1RxKernel(pucchF1RxDynDescr_t* pDynDescr)
{
   ...
   // Global id for UCI groups processed per CTA
   ...
   auto local_group = tile.meta_group_rank(); // = threadIdx.y

   int nUciInGrp = 0;
   // UCI data for this group
   pucchF1UciGrpPrms_t* group_data;
   if ((global_group + local_group) < pDynDescr->numUciGrps)
   {
       group_data = &pDynDescr->uciGrpPrms[global_group + local_group];
       nUciInGrp  = group_data->nUciInGrp;
   }

   // each thread block will process F1_NUM_UCI_GRPS_PER_BLK uci groups; one tile is assigned per uci group
   // each tile in a thread block will process one uci from the corresponding uci group
   // gridDim.z covers the maximum number of uci's in any uci group
   int uci = blockIdx.z;
   if (uci < nUciInGrp)
   {
       // cell idx
       ...
       __shared__ __half2 y_data[F1_NUM_UCI_GRPS_PER_BLK * MAX_DATA_SYMS_F1 * N_TONES_PER_PRB * F1_MAX_RX_ANTENNA];
       __shared__ __half2 y_dmrs[F1_NUM_UCI_GRPS_PER_BLK * MAX_DMRS_SYMS_F1 * N_TONES_PER_PRB * F1_MAX_RX_ANTENNA];
       __shared__ __half2 r1[F1_NUM_UCI_GRPS_PER_BLK * N_TONES_PER_PRB];
       __shared__ __half2 r2[F1_NUM_UCI_GRPS_PER_BLK * N_TONES_PER_PRB];
       ...
       __shared__ uint32_t cs_sh[F1_NUM_UCI_GRPS_PER_BLK * F1_MAX_SYMS];
       ...
       // UCI processing for each group  ----------------------------------------------------------------------------------------------------
       float dtx_thresh = __powf(rssi_linear, 1.88f) * alpha * __half2float(group_data->DTXthreshold[uci]) * d_DtxThrExp_inv[nUciInGrp - 1];
       if(dtx_thresh < 1e-16f)
       {
           dtx_thresh = 1e-16f;
       }
       ...
       else
       {
           ...
           for(int i = lane; i < group_data->nSym; i += tile.size())
           {
      ...
      */
           ...
           __half2 temp_t_dmrs;
           float2  tempf_t_dmrs;
           float   qam_est_x = 0.0f;
           float   qam_est_y = 0.0f;
           float   rsrpTemp  = 0.0f;
           float   rsrp_dB   = 0.0f;
      ...
      */
           ...
           if(group_data->freqHopFlag)
           {
               ...
               rsrp_dB = 10.0f * __log10f(rsrpTemp / static_cast<float>(2 * numRxAnt));

               switch(group_data->nSym)
               {
               case 4:
                   Wt_table_h1 = (__half*)d_Wt_1_1;
                   Wt_table_h2 = (__half*)d_Wt_1_1;
                   break;
               case 5:
                   Wt_table_h1 = (__half*)d_Wt_1_1;
                   Wt_table_h2 = (__half*)d_Wt_2_1;
                   break;
               case 6:
                   Wt_table_h1 = (__half*)d_Wt_2_1;
                   Wt_table_h2 = (__half*)d_Wt_1_2;
                   break;
               case 7:
                   Wt_table_h1 = (__half*)d_Wt_2_1;
                   Wt_table_h2 = (__half*)d_Wt2_2_2;
                   break;
               case 8:
                   Wt_table_h1 = (__half*)d_Wt1_2_2;
                   Wt_table_h2 = (__half*)d_Wt1_2_2;
                   break;
               case 9:
                   Wt_table_h1 = (__half*)d_Wt1_2_2;
                   Wt_table_h2 = (__half*)d_Wt1_2_2;
               ...
               case 10:
                   Wt_table_h1 = (__half*)d_Wt1_2_2;
                   Wt_table_h2 = (__half*)d_Wt_2_3;
                   break;
               case 11:
                   Wt_table_h1 = (__half*)d_Wt1_2_2;
                   Wt_table_h2 = (__half*)d_Wt2_3_3;
                   break;
               case 12:
                   Wt_table_h1 = (__half*)d_Wt1_3_3;
                   Wt_table_h2 = (__half*)d_Wt1_3_3;
                   break;
               case 13:
                   Wt_table_h1 = (__half*)d_Wt1_3_3;
                   Wt_table_h2 = (__half*)d_Wt_4_3;
                   break;
               case 14:
                   Wt_table_h1 = (__half*)d_Wt_4_3;
                   Wt_table_h2 = (__half*)d_Wt_3_4;
                   break;
               default: break;
               }
           ...
           else
           {
               ...
               switch(group_data->nSym)
               {
               case 4: Wt_table_h1 = (__half*)d_Wt1_2_2; break;
               case 5: Wt_table_h1 = (__half*)d_Wt_3_2; break;
               case 6: Wt_table_h1 = (__half*)d_Wt1_3_3; break;
               case 7: Wt_table_h1 = (__half*)d_Wt_4_3; break;
               case 8: Wt_table_h1 = (__half*)d_Wt_4_4; break;
               case 9: Wt_table_h1 = (__half*)d_Wt_5_4; break;
               case 10: Wt_table_h1 = (__half*)d_Wt_5_5; break;
               case 11: Wt_table_h1 = (__half*)d_Wt_6_5; break;
               case 12: Wt_table_h1 = (__half*)d_Wt_6_6; break;
               case 13: Wt_table_h1 = (__half*)d_Wt_7_6; break;
               case 14: Wt_table_h1 = (__half*)d_Wt_7_7; break;
               default: break;
               }
               ...
               for(int i = lane; i < N_TONES_PER_PRB * numRxAnt; i += tile.size())
               {
                   ...
                   for(int sym = 0; sym < group_data->nSym_dmrs; sym++)
                   {
                       ...
                       for(int j = 0; j < N_TONES_PER_PRB; j++)
                       { // Cols of Wf. Each scIdx processes a single row
                           accum = __hadd2(accum, real_mul(group_dmrs_per_uci[j * numRxAnt * group_data->nSym_dmrs + sym * numRxAnt + antIdx], d_Wf[scIdx][j]));
                       }
                       ...
                       {
                           group_h_est_iue[scIdx * numRxAnt * group_data->nSym_data + E_col * numRxAnt + antIdx] = __hadd2(
                               group_h_est_iue[scIdx * numRxAnt * group_data->nSym_data + E_col * numRxAnt + antIdx],
                               complex_conjmul(real_mul(accum, Wt_table_h1[sym * group_data->nSym_data + E_col]), d_s[scIdx]));
                       }
                   }
               }
...
// go to 0 with low SNR scenarios
                ...
                if(0)
                {
                    printf("uci_idx=%d, abs2_qam=%f, dtx_thresh=%f, rssi_linear=%f, rssi_linear_pow=%f, DTX_in=%f, exp_inv=%f, alpha=%f\n", group_data->uciOutputIdx[0], abs2_qam, dtx_thresh, rssi_linear, __powf(rssi_linear, 1.88), __half2float(group_data->DTXthreshold[0]), d_DtxThrExp_inv[nUciInGrp - 1], alpha);
                }
#endif
                ...
                {
                    sr = group_data->srFlag[uci] && (group_data->bitLenHarq[uci]);
...
void  pucchF1Rx::kernelSelect(uint32_t                   nUciGrps,
                              ...
                              cuphyPucchF1RxLaunchCfg_t* pLaunchCfg)
{
   ...
   uint8_t max_uci_in_group = 0;
   for(int grp = 0; grp < nUciGrps; grp++)
   {
       max_uci_in_group = std::max(pCpuDynDesc->uciGrpPrms[grp].nUciInGrp, max_uci_in_group);
   }

   // each thread block will process up to 1 UCI from F1_NUM_UCI_GRPS_PER_BLK UCI groups
   // if UCI group has less number of UCIs than max_uci_in_group, it will early exit
   // ToDo launching with the following gridDim, based on max_uci_in_group, can potentially be inefficient for cases where variance in number of UCIs among UCI groups is large
   dim3 gridDim(div_round_up(nUciGrps, F1_NUM_UCI_GRPS_PER_BLK), 1, max_uci_in_group);
   dim3 blockDim(F1_CG_SIZE, F1_NUM_UCI_GRPS_PER_BLK);
                      ...
                      cudaStream_t               strm)                                      // stream to perform copy
{
   ...
   for(int uciIdx = 0; uciIdx < nF1Ucis; ++uciIdx)
   {
      ...
      if(newGrpFlag == 1) 
      {
         ...
         pCpuDynDesc->uciGrpPrms[nUciGrps].nUplinkStreams   = pF1UciPrms[uciIdx].nUplinkStreams;
