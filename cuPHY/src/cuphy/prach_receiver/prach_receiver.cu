...
FftKernelHandle prach_get_fft_param_for_arch(unsigned int cudaDeviceArch, dim3& block_dim, uint& shared_memory_size) { 
    switch(cudaDeviceArch) {
        // All SM supported by cuFFTDx
        case  700: return prach_get_fft_param<Tscalar, FftSize,  700>(block_dim, shared_memory_size);
        case  750: return prach_get_fft_param<Tscalar, FftSize,  750>(block_dim, shared_memory_size);
        case  800: return prach_get_fft_param<Tscalar, FftSize,  800>(block_dim, shared_memory_size);
        case  860: return prach_get_fft_param<Tscalar, FftSize,  860>(block_dim, shared_memory_size);
        case  870: return prach_get_fft_param<Tscalar, FftSize,  870>(block_dim, shared_memory_size);
        case  890: return prach_get_fft_param<Tscalar, FftSize,  890>(block_dim, shared_memory_size);
        case  900: return prach_get_fft_param<Tscalar, FftSize,  900>(block_dim, shared_memory_size);
        case 1000: return prach_get_fft_param<Tscalar, FftSize,  1000>(block_dim, shared_memory_size);
        case 1200: return prach_get_fft_param<Tscalar, FftSize,  1200>(block_dim, shared_memory_size);
        case 1210: return prach_get_fft_param<Tscalar, FftSize,  1210>(block_dim, shared_memory_size);
        default: 
...
FftKernelHandle prach_get_fft_param(unsigned int Nfft, unsigned int cudaDeviceArch, dim3& block_dim, uint& shared_memory_size) { 
    ...
    if(Nfft == 256) {
        return prach_get_fft_param_for_arch<Tscalar, 256>(cudaDeviceArch, block_dim, shared_memory_size);
    }
    else if(Nfft == 1024) {
        return prach_get_fft_param_for_arch<Tscalar, 1024>(cudaDeviceArch, block_dim, shared_memory_size);
    }
    else {
